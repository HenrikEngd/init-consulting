...
INIT is a one-person consultancy that improves workflows, automates routine
work and connects the systems a business already uses. Engagements are clearly
scoped, with an agreed price and deliverable. Everything below follows from
that: sparse, exact and nothing decorative.
